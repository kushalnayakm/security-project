...
class QrCode(Base):
    ...
    show_welcome: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default=text("TRUE"))
    welcome_title: Mapped[str | None] = mapped_column(String(150), server_default=text("'Welcome'"))
    welcome_message: Mapped[str | None] = mapped_column(Text)
    welcome_logo: Mapped[str | None] = mapped_column(Text)
